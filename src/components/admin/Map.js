...
import '../../assets/admin/css/map.css';

mapboxgl.accessToken = 'pk.eyJ1IjoiZmVyeWVsYmVuY2hhYWJlbmUiLCJhIjoiY2t6ZzA2bThoMHZkODJvbnl2ZzJocGN4aiJ9.vkpeWClxobUa6ePXqj9Ulg';
...
const Map = () => {
  ...
  useEffect(() => { //'mapbox://styles/mapbox/streets-v11'
